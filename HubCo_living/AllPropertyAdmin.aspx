<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllPropertyAdmin.aspx.cs" Inherits="HubCo_living.AllPropertyAdmin" %>
                        ...
                        <table>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <asp:ImageButton ID="propImage" runat="server" ImageUrl='<%# GetImage(Eval("imageContent")) %>'  OnCommand="Image_Click" CommandName="ImageClick" CommandArgument='<%# Eval("roomID") %>' CssClass="picture"/>
